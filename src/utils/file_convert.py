...
def tgv_to_csv(tgv_blob_content) -> str:
    ...
    try:
        ...
        df.to_csv(Const.NEW_OUTPUT, header=False, index=False)

        Log.info('done activate - validation tgv_to_csv ')
        return Const.NEW_OUTPUT
...
def csv_to_tgv(csv_file_path, tgv_file_path):
    ...
    try:
        ...
        error_message: str = "error while converting csv_to_tgv data : " + str(e)
